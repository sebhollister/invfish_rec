...
class Int64Vector(object):
    ...
    def __len__(self) -> "std::vector< long long >::size_type":
        r"""__len__(Int64Vector self) -> std::vector< long long >::size_type"""
    ...
    def __getslice__(self, i: 'std::vector< long long >::difference_type', j: 'std::vector< long long >::difference_type') -> "std::vector< long long,std::allocator< long long > > *":
        r"""
        __getslice__(Int64Vector self, std::vector< long long >::difference_type i, std::vector< long long >::difference_type j) -> Int64Vector
    ...
    def __setslice__(self, *args) -> "void":
        r"""
        __setslice__(Int64Vector self, std::vector< long long >::difference_type i, std::vector< long long >::difference_type j)
        ...
        __setslice__(Int64Vector self, std::vector< long long >::difference_type i, std::vector< long long >::difference_type j, Int64Vector v)
    ...
    def __delslice__(self, i: 'std::vector< long long >::difference_type', j: 'std::vector< long long >::difference_type') -> "void":
        r"""
        __delslice__(Int64Vector self, std::vector< long long >::difference_type i, std::vector< long long >::difference_type j)
    ...
    def __delitem__(self, *args) -> "void":
        r"""
        __delitem__(Int64Vector self, std::vector< long long >::difference_type i)
    ...
    def __getitem__(self, *args) -> "std::vector< long long >::value_type const &":
        ...
        __getitem__(Int64Vector self, std::vector< long long >::difference_type i) -> std::vector< long long >::value_type const &
    ...
    def __setitem__(self, *args) -> "void":
        ...
        __setitem__(Int64Vector self, std::vector< long long >::difference_type i, std::vector< long long >::value_type const & x)
    ...
    def pop(self) -> "std::vector< long long >::value_type":
        r"""pop(Int64Vector self) -> std::vector< long long >::value_type"""
    ...
    def size(self) -> "std::vector< long long >::size_type":
        r"""size(Int64Vector self) -> std::vector< long long >::size_type"""
    ...
    def get_allocator(self) -> "std::vector< long long >::allocator_type":
        r"""get_allocator(Int64Vector self) -> std::vector< long long >::allocator_type"""
    ...
    def __init__(self, *args):
        ...
        __init__(Int64Vector self, std::vector< long long >::size_type size) -> Int64Vector

        Parameters
        ----------
        size: std::vector< long long >::size_type

        __init__(Int64Vector self, std::vector< long long >::size_type size, std::vector< long long >::value_type const & value) -> Int64Vector
    ...
    def front(self) -> "std::vector< long long >::value_type const &":
        r"""front(Int64Vector self) -> std::vector< long long >::value_type const &"""
        return _model.Int64Vector_front(self)

    def back(self) -> "std::vector< long long >::value_type const &":
        r"""back(Int64Vector self) -> std::vector< long long >::value_type const &"""
    ...
    def capacity(self) -> "std::vector< long long >::size_type":
        r"""capacity(Int64Vector self) -> std::vector< long long >::size_type"""
